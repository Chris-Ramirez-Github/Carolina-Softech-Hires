...
//	      		"WHERE id = '"+ id +"';";
	      String searchQuery = "Delete jobdb.*,applydb.* from userdb.jobdb,userdb.applydb where jobdb.username = '"+username+"' AND jobdb.id = '"+id+"' AND applydb.employerUsername = '"+username+"' AND applydb.id = '"+id+"';"; 
