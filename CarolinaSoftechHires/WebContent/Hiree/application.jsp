...
<!--       <li><a href="JobSearch.jsp" ><span class="glyphicon glyphicon-briefcase" ></span> Job Search</a></li>
 -->    </ul>
	...
	<h1 style="text-align:center;margin-top:10px;">Application Form</h1>
	<hr>

	<div class="container"  style="width:50%;
	margin: 25px auto 10px auto;box-shadow:0 41.8px 33.4px rgba(0, 0, 0, 0.086);padding:25px;">
	<div > 
<form class="form-vertical" action="../ApplyJobSubmit" enctype="multipart/form-data" method="post" >
<div class="form-group col-md-12">
    <input type="hidden" class="form-control"  name="id" value="<%= request.getParameter("id")%>" maxlength="3" required>
  	</div>
 <div class="form-group col-md-12">

    <input type="hidden" class="form-control"  name="employerUsername" value="<%= request.getParameter("employerUsername")%>" maxlength="16" required>
     <!-- <p id="passwordHelpBlock" class="form-text text-muted">No more than 45 Character<p> -->
  	</div>
<div class="form-group col-md-12">
    <label for="username">Username: </label>
    <input type="text" class="form-control"  name="employeeUsername" maxlength="16" required>
     <!-- <p id="passwordHelpBlock" class="form-text text-muted">No more than 45 Character<p> -->
  	</div>
<div class="form-group col-md-12">
 ...
 <option selected > -- select a city -- </option>
    ...
    <input style="width:50%;margin: 0px auto;" type="text" class="form-control"  name="resumeTitle" maxlength="15" required/>
    </div>
    <div class="form-group col-md-12" style="text-align:center;">
    <label for="fileType">Select File Type</label>
    <select style="width:50%;margin: 0px auto;" class="form-control" id="fileType" name="fileType" style="margin-left:35%;width:30%;" required>
	...
	<input style="width:50%;margin: 0px auto;" type="file" name="file" id="file" style="margin: 1px auto;"/><br>
        </div>
