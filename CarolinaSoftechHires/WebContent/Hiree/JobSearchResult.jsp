	...
	<h1 style="text-align:center;margin-top:10px;"> Job Search Result</h1>
	 ...
	 <table id="hireList" style="width: 90%;">
          <tr>
            	...
            	<th style="display:none;">Company Username</th>
                ...
                <th style="text-align:center;">State</th>
                 <th style="text-align:center;">Apply to Job</th>
            ...
            <c:forEach var="listJobs" items="${jobSearch}">
                <tr>
                	...
                	<td style="display:none;"><c:out value="${listJobs.username}" /></td>
                    ...
                    <td>
                     <a href="${pageContext.request.contextPath}/Apply?id=<c:out value='${listJobs.id}' />&username=<c:out value='${listJobs.username}' />"><button type="submit" class="btn btn-default">Apply</button></a>                                     
                    </td>
                </tr>
            </c:forEach>
        </table>
