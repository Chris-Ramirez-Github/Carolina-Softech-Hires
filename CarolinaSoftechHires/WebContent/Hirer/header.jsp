<header>
  ...
  <div class="container-fluid" style="background-color:#28559A;">
    <ul class="nav navbar-nav navbar-none" style="margin-left:37%;">
      ...
      <li><a href="PostJob.jsp" ><span class="glyphicon glyphicon-briefcase" ></span> Post a Job</a></li>
    </ul>
  </div>
