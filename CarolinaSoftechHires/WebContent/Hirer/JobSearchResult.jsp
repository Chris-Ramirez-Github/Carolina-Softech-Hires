	 ...
	 <table id="hireList" style="width: 90%;">
            ...
            <c:forEach var="listJobs" items="${jobSearch}">
                <tr>
                    ...
                    <td>
                     <a href="${pageContext.request.contextPath}/Delete?id=<c:out value='${listJobs.id}' />&username=<c:out value='${listJobs.username}' />"><button type="submit" class="btn btn-default">Delete Job Listing</button></a>                                     
                    </td>
                </tr>
            </c:forEach>
