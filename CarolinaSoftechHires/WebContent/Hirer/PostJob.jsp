...
<body>
  ...
  <%@ include file = "header.jsp" %>
	...
	<h1 style="text-align:center;color:#28559A;margin-top:10px;" >Post a Job</h1>
  ...
  <%if(message == null || message.length() == 0){
   ...
   <h2  style="text-align:center; padding-top:25px;"> <%= request.getParameter("successMessage")%></h2>
   <% } %>  
   
<div class="container" style="width:100%;
	margin-bottom: 0px;">
<form class="form-vertical" action="../JobPost" method="post" style="width:75%;
	margin: 10px auto 10px auto;box-shadow:0 41.8px 33.4px rgba(0, 0, 0, 0.086);padding:25px;">
    ...
    <input type="text" class="form-control" id="name" name="name"  maxlength="46" required>
  	</div>
  	
  	<div class="form-group col-md-4">
     <label for="phone">Phone Number: </label>
    <!--  <input type="tel" class="form-control" id="phone" name="phone" required> -->
  <input type="tel" id="phone" class="form-control" name="phone" placeholder="000-000-000" pattern="[0-9]{3}-[0-9]{3}-[0-9]{4}" maxlength="12" required>
  <p id="passwordHelpBlock" class="form-text text-muted">
	Phone must follow this format 000-000-0000</p>
  	 </div> 
    ...
    <textarea class="form-control" id="job-description" name="job-description" rows="10" maxlength="749" required></textarea>
  	</div>
  	   	
  	   	
  	  <div class="form-group col-xs-4 col-md-4">
        <label for="employment-time" class="control-label">Type of Job: </label>
     <select  class=" form-control selectpicker" id="employment-time" name="employment-time" required>
     			   <option disabled> -- select a type of job -- </option>
                   <option value = "Part-Time">Part-Time</option>
                   <option value = "Full-Time">Full-Time </option>
                   </select>
    </div>
    <div class="form-group col-xs-4 col-md-4">
         <label for="employment-pay" class="control-label">Pay Rate:</label>
     <select  class="form-control selectpicker" id="employment-pay" name="employment-pay" required> 
     			   <option disabled> -- select Pay Rate -- </option>
                   <option value = "Hourly">Hourly</option>
                   <option value = "Yearly">Yearly</option>
                   </select>
    </div>
    <div class="form-group col-xs-4 col-md-4">
        <label for="employment-amount" class="control-label">Pay Amount: </label>
   		<input class="form-control selectpicker" type="text" name="employment-amount" maxlength="16" required> 
    </div>
