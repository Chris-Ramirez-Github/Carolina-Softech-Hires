<h2 style="text-align:center;margin-bottom:10px;color:#28559A;"> Log Back in</h2>
<form class="form-vertical" action="../Login" method="post" style="width:50%;
	margin: 5px auto -100px auto;box-shadow:0 41.8px 33.4px rgba(0, 0, 0, 0.086);padding:25px;">
